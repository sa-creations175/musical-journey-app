...
describe('every catalog has a source wired', () => {
  ...
  it('divides by the catalog, not by what is in the log', () => {
    ...
    expect(totals).toMatchObject({
      ...
      // 627 chord progressions = 721. (Was 514: the chord-progressions
      ...
      // for the ♯4's dim7, and 489 → 721 when every pair became two
      // cards — all 10 Sep.)
      ...
      //   chord progressions: 12 key-detection + 467 motion +
