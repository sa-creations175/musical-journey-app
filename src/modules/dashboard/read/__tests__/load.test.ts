...
describe('every catalog has a source wired', () => {
  ...
  it('divides by the catalog, not by what is in the log', () => {
    ...
    expect(totals).toMatchObject({
      ...
      // 367 chord progressions = 461. (Was 514: the chord-progressions
      ...
      // motions, and 458 → 461 the same day for the three same-root
      // moves.)
      ...
      //   chord progressions: 12 key-detection + 207 motion +
...
describe('routing sources to catalogs', () => {
  ...
  it('keeps mental visualisation out of S&P coverage and score', () => {
    ...
    // branch scored 25 and covered one of 1572.
    expect(sp.root.totalItems).toBe(1572);
