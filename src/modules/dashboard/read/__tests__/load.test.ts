...
describe('routing sources to catalogs', () => {
  ...
  it('keeps mental visualisation out of S&P coverage and score', () => {
    ...
    // branch scored 25 and covered one of 1152.
    expect(sp.root.totalItems).toBe(1152);
