...
/** LOWERCASE, AND NOT AN OVERSIGHT. A triad and a seventh are chord
 *  types — the notation exemption in CLAUDE.md covers them the same
 *  way it covers "sus2 triads". A chart header naming a musical object
 *  is still naming a musical object. */
