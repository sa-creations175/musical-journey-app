...
const DIATONIC_QUALITY_CARDS: Flashcard[] = [
  ...
  { id: 'dq-nm-2', category: 'diatonic-qualities', categoryName: CATEGORY_LABELS['diatonic-qualities'],
    ...
    correctAnswer: 'half-diminished 7',
    decoys: ['minor 7', 'dominant 7', 'diminished 7'],
    explanation: "The ii in natural minor is half-diminished (m7b5) — Bm7b5 in the key of A minor. It's the predominant chord in every minor-key 2-5-1 (Bm7b5 → E7 → Am7) — fundamental jazz and gospel turnaround vocabulary.",
  ...
  { id: 'dq-nm-7', category: 'diatonic-qualities', categoryName: CATEGORY_LABELS['diatonic-qualities'],
    ...
    correctAnswer: 'dominant 7',
    decoys: ['major 7', 'minor 7', 'half-diminished 7'],
    explanation: "The VII in natural minor is a dominant 7 on the flat-7 — the bVII you hear all over Mixolydian rock and gospel (F7 in the key of G minor). It doesn't resolve like a V7; it just sits, blue and broad.",
