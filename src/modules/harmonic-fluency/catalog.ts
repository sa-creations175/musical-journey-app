...
const SLASH_CHORD_CARDS: Flashcard[] = [
  ...
  { id: 'sc-6', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    explanation: "A 1st-inversion triad puts the 3rd in the bass — like C/E. Gentler than root position, used widely in R&B and gospel for smooth step-wise bass motion. Hymn writers and church pianists rely on it heavily. In Nashville numbers, a 1-chord 1st inversion is written 1/3.",
  ...
  { id: 'sc-16', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    decoys: ['its 5th', 'its 7th', 'the root'],
    explanation: "First inversion always puts the 3rd in the bass. For the V chord the 3rd is the leading tone — in C major that's B under a G chord = G/B (Nashville: 5/7), and that leading-tone bass pulls up a half step to 1. This is the chord-tone twin of the 5/7 card.",
