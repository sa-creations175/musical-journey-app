...
const SLASH_CHORD_CARDS: Flashcard[] = [
  { id: 'sc-1', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'C/E is in which inversion?', correctAnswer: '1st inversion (3rd in bass)',
  ...
  { id: 'sc-2', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'C/G is in which inversion?', correctAnswer: '2nd inversion (5th in bass)',
  ...
  { id: 'sc-3', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'Cmaj7/B is in which inversion?', correctAnswer: '3rd inversion (7th in bass)',
  ...
  { id: 'sc-4', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    correctAnswer: 'V with the 3rd (leading tone) in the bass',
    decoys: ['V with the 5th in the bass', 'iii with the root in the bass', 'vii° with the root in the bass'],
    explanation: "G/B in C major puts the leading tone (B) in the bass underneath the V chord — and that B pulls right up to C on the next chord. Classic descending-bass device used in countless gospel and soul ballads: I → V/B → vi (C → G/B → Am).",
  ...
  { id: 'sc-5', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    explanation: "A 2nd-inversion triad puts the 5th in the bass — like C/G. This bass note is less stable than the root, so 2nd inversion is mostly used for passing moments or specific voice-leading needs (ascending bass through a progression, for example).",
  ...
  { id: 'sc-6', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    explanation: "A 1st-inversion triad puts the 3rd in the bass — like C/E. Gentler than root position, used widely in R&B and gospel for smooth step-wise bass motion. Hymn writers and church pianists rely on it heavily.",
  ...
  { id: 'sc-7', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    explanation: "F/G in C is a classic V7sus4 substitute — G in the bass, F-A-C on top gives you the G7sus sound without the 3rd. Widely used in neo-soul, gospel, and modern R&B for a suspended, 'held' feel before resolution to the I.",
    skillTag: 'slash-function-F-G' },
  { id: 'sc-8', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'I/3 in the key of C major is _____',
    correctAnswer: 'C/E',
    decoys: ['C/G', 'C/B', 'E/C'],
    explanation: "I/3 means the I chord with the 3rd of the key in the bass — in C, that's C/E. This 'over-three' notation is how Nashville-number-system players mark inversions on a chart: the slash number tells you which scale degree goes in the bass.",
    skillTag: 'slash-notation-I-3-in-C' },
  { id: 'sc-9', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'V/7 in the key of C major is _____',
    correctAnswer: 'G/B',
    decoys: ['G/F', 'G/D', 'G/F#'],
    explanation: "V/7 in C means the V chord with the 7th degree of the key (B) in the bass — that's G/B. The leading tone in the bass gives smooth step-up resolution to I (B → C).",
    skillTag: 'slash-notation-V-7-in-C' },
  { id: 'sc-10', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'IV/5 in the key of C major is _____',
    correctAnswer: 'F/G',
    decoys: ['F/C', 'F/A', 'F/D'],
    explanation: "IV/5 in C means IV with the 5th of the key (G) in the bass — F/G. Sounds and functions like a G7sus4 — a 'held' dominant that resolves down to C.",
    skillTag: 'slash-notation-IV-5-in-C' },
  { id: 'sc-11', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'vi/b7 in the key of C major is _____',
    correctAnswer: 'Am/Bb',
    decoys: ['Am/B', 'Am/G', 'Am/C'],
    explanation: "vi/b7 in C puts the flat-7 of the key (Bb) in the bass under vi — that's Am/Bb. The Bb sets up either a chromatic descent (B → Bb → A) or a half-step pull up to C; a slick voice-leading trick used in jazz reharms.",
    skillTag: 'slash-notation-vi-b7-in-C' },
  { id: 'sc-12', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    question: 'The descending bass line I - V/7 - vi - I/3 moves the bass by _____',
  ...
  { id: 'sc-15', category: 'slash-chords', categoryName: CATEGORY_LABELS['slash-chords'],
    ...
    correctAnswer: 'control bass movement (voice leading)',
