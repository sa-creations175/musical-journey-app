    ...
    try {
      ...
      if (effectiveParentGoalId === null && records.length > 1) {
        ...
        await db.goals.add({
          ...
          relatedModules,
          relatedItems,
          startDate: defaultStartDate(draft.scope, now),
      ...
      for (let recordIdx = 0; recordIdx < records.length; recordIdx++) {
        ...
        const goal: Goal = {
          ...
          startDate: reuseOriginalId ? initialGoal!.startDate : defaultStartDate(draft.scope, now),
          targetDate: draft.targetDate,
...
// CategoryPillButton has been extracted to ./atoms. Re-exported here
// under the same name so the existing import sites in
// yearlyAnchorDimensions.tsx and YearlyAnchorFlow.tsx keep working
// without churn. Future cleanup pass should update those imports to
// point at './atoms' directly and drop this re-export.
export { CategoryPillButton } from './atoms';
